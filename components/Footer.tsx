...
const Footer = () => {
  return (
    <footer className="bg-black z-[180] text-white   pt-10 pb-3  w-full ">
        ...
        <div className="container text-center md:flex  md:justify-between md:items-start">
          ...
          <div>
            ...
            <div className="flex md:justify-center items-center  mt-6 md:mt-6 gap-6">
              ...
              >
                <FaInstagram  className="w-6 h-full"/>
      ...
      <div className=" bg-black md:gap-0 gap-2  md:mb-0 mb-2 md:flex-row flex-col flex justify-center  px-4 w-full md:px-40  py-4 ">
        ...
        {/* <p className="text-white/70  md:text-[14px]">
          Designed & Developed by <Link href={'https://theinternetcompany.one/'}>TIC Global</Link> 
        </p> */}
      </div>
    </footer>
  );
