...
export default function Home() {
  ...
  useEffect(() => {
    const fetchUserDetails = async () => {
      try {
        ...
        setUserRole(response.data.user.role); // Assuming user role is directly available
      } catch (error) {
  ...
  return (
    <div className="w-full overflow-hidden flex flex-col items-center justify-center">
      <Navbar />
      {userRole === "user" && <ReOrderModal />}
      <Mobilenav />
      <Hero />
      <div className="bg-black w-full items-center justify-center text-white">
      <ScrollingText />
    </div>
      <Steps />
      <ThridSection />
...
const Steps = () => {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 px-4 max-w-5xl">
        {/* Step 1 */}
        <div
        ...
        >
          <div className="flex px-6 py-8 gap-2">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-sm text-left">
                Hit on schedule wash and relax while we restore your car’s
                shine!
              </p>
            </div>
          </div>
...
import ScrollingText from "@/components/ReusableComponent/ScrollingText";
